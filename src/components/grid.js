                ...
                <div className="card border">
                    <div className="card-header bg-success">
                        <div className="d-flex justify-content-between">
                            <div className="lead text-white">Toutes les tâches</div>
                            <div className="d-flex">
                                <div className="me-3 bg-light px-2 rounded">
                                    <span onClick={this.props.onChangeAdd}>
                                        {this.props.add ? 
                                ...
                                <div className="d-flex border bg-light px-2 rounded">
                                    <div>
                                    ...
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-grid-3x2-gap" viewBox="0 0 16 16">
